...
#SBATCH -J run_AMUXL025_S19_TOT_TEMPm05
...
CASE='S19_TOT_TEMPm05' # should not be too long [>15 char.] otherwise, NEMO file names are affected
...
FORCINGdir='/scratch/cnt0021/egi6035/SHARED/FORCING_SETS/AMUXL025/TOT_TEMPm05/JRA55' # Atmospheric forcing
