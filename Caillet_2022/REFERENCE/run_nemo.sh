...
#SBATCH -J run_AMUXL025_REFERENCE
...
CASE='REFERENCE' # should not be too long [>15 char.] otherwise, NEMO file names are affected
...
FORCINGdir='/scratch/cnt0021/egi6035/SHARED/FORCING_SETS/JRA55' # Atmospheric forcing
