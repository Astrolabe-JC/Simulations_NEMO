...
#SBATCH -J run_AMUXL025_S02_PREC048_SLP
...
CASE='S02_PREC048_SLP' # should not be too long [>15 char.] otherwise, NEMO file names are affected
...
FORCINGdir='/scratch/cnt0021/egi6035/SHARED/FORCING_SETS/AMUXL025/PRECIPx048_SLOPE/JRA55' # Atmospheric forcing
