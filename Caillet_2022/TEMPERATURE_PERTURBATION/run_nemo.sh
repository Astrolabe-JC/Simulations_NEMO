...
#SBATCH -J run_AMUXL025_S07_TEMPm10_SLP
...
CONFEXE='AMU12r_htau_flux'  # only for nemo.exe

CASE='S07_TEMPm10_SLP' # should not be too long [>15 char.] otherwise, NEMO file names are affected
...
FORCINGdir='/scratch/cnt0021/egi6035/SHARED/FORCING_SETS/AMUXL025/TEMPm10_SHx048_SLOPE/JRA55' # Atmospheric forcing
